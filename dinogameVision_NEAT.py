""" Includes visualization of the opencv algorithm """
...
import find
import pyautogui
import threading # to improve perfomance
...
if __name__ == '__main__':
    ...
    # threading to reduce lag
    NEAT = threading.Thread(target=run, daemon=False, args=(config_path,)) # killed when program is terminated
    NEAT.start()
    show_vision()
    # run(config_path)
    # pyautogui.press('up')
